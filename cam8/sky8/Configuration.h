...
#define STRING_CONFIG_H_AUTHOR "Peter DeVries - Sky8" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sky8"
 ...
 */
#define PREVENT_LENGTHY_EXTRUDEls
...
#define DEFAULT_AXIS_STEPS_PER_UNIT {AXIS_STEPS_PER_UNIT_X, AXIS_STEPS_PER_UNIT_Y, 400, 400}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 100, 25 }
 ...
 *   (0,0)
 */
// #define X_PROBE_OFFSET_FROM_EXTRUDER 28.5  // X offset: -left  +right  [of the nozzle]
...
// DEBUG #define MIN_SOFTWARE_ENDSTOPS
...
// DEBUG #define MAX_SOFTWARE_ENDSTOPS
